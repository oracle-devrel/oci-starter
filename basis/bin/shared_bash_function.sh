...
get_user_details() {
  if [ "$OCI_CLI_CLOUD_SHELL" == "True" ];  then
    ...
    # 
    # OCI_RESOURCE_PRINCIPAL_RPST=eyJraWQiOiJhc3dfb2MxX2o0eGQiLCJhbGciOiJSUzI1NiJ9..IQKm2CCM-Jmo_acubjZFwM347_lEfUGfAPwkSRKgEYUCIX02hgBq7Wkbly1rLdEl0hhl-IphRud_0o2dQaSanZTBJy-_tiNYgpYuJx20fCyg8mRDZbBQxF4h-iVz9RWxqWGQ80uB7E6gZ0TLPDiidqVnzms3a-Wlk65izg_yn9ZZbth1XGCSau1a1ldLUreU1ZYWFqXipN6w1CbcHEX9cHUNTcyWnb52E2Y67iUc1gCKunozbriq8gKxcgyGjjwBqFqVTR97-fMncNVolYwR-Hg2YplRlDa-LrS3LrZKuqhoEwa9BS0mhMmueNVAlGuCWOpVdEAxBJN-k7tbi8JUSg   
    echo "OCI_RESOURCE_PRINCIPAL_RPST=$OCI_RESOURCE_PRINCIPAL_RPST"
    IFS="."
    read -a array <<< $OCI_RESOURCE_PRINCIPAL_RPST
    unset IFS
    echo array1=${array[1]} 
    data2=`echo ${array[1]} | base64 -d`
    echo data2=$data2
    export TF_VAR_tenancy_ocid=`echo $data2 | jq -r .tenant`
